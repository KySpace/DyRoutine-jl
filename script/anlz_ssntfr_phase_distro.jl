...
path_output = joinpath(path_root, "AnlzRoutine", "39.PhaseDistro.MovingCentY.LargerYRng")
...
function draw_profile_inspector!(
    ...
    btn_phase = Button(gl_ctrl[5, 1:3]; label=lift(s -> "phase: $(s)", obs_phase_mode), height=30)
